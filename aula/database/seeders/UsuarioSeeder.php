...
class UsuarioSeeder extends Seeder
{
    ...
    {
        $nomesFemininos = [
            'Maria', 'Ana', 'Juliana', 'Beatriz', 'Camila', 'Patrícia', 'Mariana', 'Amanda', 'Larissa', 'Fernanda',
            'Aline', 'Vanessa', 'Renata', 'Priscila', 'Daniela', 'Carolina', 'Isabela', 'Bianca', 'Tatiana', 'Natália',
            'Letícia', 'Sabrina', 'Adriana', 'Cristina', 'Elaine'
        ];
        ...
        for ($i = 0; $i < 60; $i++) {
            ...
            $sexoUsuario = in_array($primeiroNome, $nomesFemininos) ? 'Feminino' : 'Masculino';
